...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='채팅방';
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='채팅메세지';
...
CREATE TABLE `event` (
                         ...
                         PRIMARY KEY (`evt_no`),
                         KEY `ad_id` (`ad_id`),
                         CONSTRAINT `event_ibfk_2` FOREIGN KEY (`ad_id`) REFERENCES `administer` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='이벤트';
...
CREATE TABLE `img` (
                       ...
                       `last_id` varchar(10) DEFAULT NULL,
                       PRIMARY KEY (`no`)
) ENGINE=InnoDB AUTO_INCREMENT=5805 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='이미지저장소';
...
CREATE TABLE `question_board` (
                                  `no` int NOT NULL AUTO_INCREMENT,
                                  `ur_id` varchar(25) DEFAULT NULL,
                                  `q_s_cd` varchar(10) DEFAULT NULL,
                                  `que_i_cd` bigint DEFAULT NULL,
...
CREATE TABLE `user_info` (
                             `ur_id` varchar(25) NOT NULL,
                             `nick` varchar(20) NOT NULL,
                             `img_no` bigint NOT NULL DEFAULT '0',
                             `contents` text,
                             `img_full_rt` text NOT NULL,
                             `view_cnt` int DEFAULT '0',
                             ...
                             `group_no` int DEFAULT NULL,
                             PRIMARY KEY (`ur_id`),
                             KEY `user_info_groupno_fk` (`group_no`),
                             CONSTRAINT `user_info_groupno_fk` FOREIGN KEY (`group_no`) REFERENCES `img_group` (`group_no`),
